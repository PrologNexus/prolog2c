%%%% enigma - https://github.com/Gariben/Prolog/tree/master/Enigma_Machine
...
main :-
	S = 'dievernunftistgeistindemdiegewissheitallerealitaetzuseinzurwahrheiterhobendsiesichihrerselbstalsihrerweltundderweltalsihrerselbstbewusstist',
	atom_chars(S, CS),
	enigma(CS,[t,h,q],[[a,c],[b,f]],O),
	atom_chars(R, O),
	display(R), nl,
	R == 'ssmyocsirvsveijhnymvwxxlpfmnmpnajiggxuiedduoqnhqqdpjnbxbndijyqlfctkihtdznmvptcvegpqcnhdxpryiywhdzjxmfyxifobwsvvaiyjpgitwjpjmnqqhzcyoybleeoi'.
